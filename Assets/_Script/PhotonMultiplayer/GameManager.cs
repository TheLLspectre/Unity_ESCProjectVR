...
{
    [AddComponentMenu("TheRed/Multiplayer/GameManager")]
    public class GameManager : MonoBehaviourPunCallbacks
    {
        ...
        private void Start()
        {
            if (!isOffline)
            {
                ...
                {
                    if (TRG.PlayerController.LocalPlayerInstance == null)
                    {
                        ...
                        if (sp != null)
                            PhotonNetwork.Instantiate(this.playerPrefab.name, sp.transform.position, sp.transform.rotation, 0);
                        else
            ...
            else
            {
                GameObject sp = GameSetup.Instance.GetSpawnPoint(0);
                if (sp != null)
                    Instantiate(this.playerPrefab, sp.transform.position, sp.transform.rotation);
                else
                    Instantiate(this.playerPrefab, new Vector3(0, 10, 0), Quaternion.identity);
            }
        }
